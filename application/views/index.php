	...
	<div class="banner_inner d-flex align-items-center">
		...
		<div class="container">
			<div class="banner_content text-center">
				<h3 data-aos="fade-up" data-aos-duration="1600">Belajar Dimana Saja & Kapan Saja <br /> Mudah Dengan Socamp</h3>
				<p data-aos="fade-up" data-aos-duration="1900">Dengan Socamp kemudahan kegiatan belajar mengajar dapat terpenuhi. Para guru dan siswa dapat
					belajar meski banyak halangan atau rintangan. Nikmati Pembelajaran terstruktur dan efektif menggunakan Socamp serta kemudahan belajar dengan menggunakan aplikasi kami. </p>
...
<!--================ Illustrations Area =================-->
<section class="Socamp-for-indonesia p_20">
	<div class="container">
		<div class="row">
		...
		<div class="row">
			<div class="col-md-7 mx-auto">
				<div class="main_title">
					<h2 data-aos="fade-up" data-aos-duration="2000">Socamp Dibuat Untuk Meningkatkan Kualitas Pembelajaran Di Indonesia</h2>
					...
					<a href="#"><button data-aos="fade-up" data-aos-duration="2400" class="bubbly-button">Download Socamp <span class="lnr lnr-arrow-right"></span></button></a>
				</div>
			</div>
		</div>
	</div>
...
<section class="courses_area p_40">
	<div class="container">
		<div class="main_title">
			<h2 data-aos="fade-up" data-aos-duration="1600">Pelajaran Yang Tersedia di Socamp</h2>
...
<section class="team_area p_20">
	<div class="container">
		<div class="main_title">
			<h2 data-aos="fade-up" data-aos-duration="1800">Testimonial Para Siswa Socamp</h2>
