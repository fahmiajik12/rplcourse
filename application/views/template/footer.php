    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <h4 class="footer_title">Tentang Socamp</h4>
                <p>
                    Web Edukasi Open Source yang dibuat oleh Kelompok1. Socamp adalah Web edukasi yang dilengkapi video, materi dan sistem ujian yang tersedia secara gratis. Socamp dibuat ditujukan agar para siswa dan guru dapat terus belajar dan mengajar dimana saja dan kapan saja.
                </p>
            </div>
        </div>
        <div class="row footer-bottom d-flex justify-content-between align-items-center">
            <p class="col-lg-8 col-md-8 footer-text m-0">
                ...
                <a href="https://colorlib.com" target="_blank">Colorlib</a> <br> Socamp is made with <span class="text-danger"> &#10084;</span> by <a href="#">Kelompok1 </a> with MIT License
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
                    ...
                    <div class="row">
                        ...
                        <div class=" col-md-6">
                            <form action="<?= base_url('welcome/validateLogin') ?>" method="post">
                                ...
                                <button class="btn btn-block font-weight-bold" style="background-color: #3abaf4;color:white;font-size:18px;">Login
                                    Sekarang!</button>
                            </form>
                        </div>
                    </div>
